    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Imagenes Nuevas</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Imagenes Nuevas</li>
                        </ol>
                    </nav>
                </div>
            </div>
            {{-- <h6 class="mb-0 text-uppercase">Imagenes Nuevas para FMD</h6> --}}
            <hr/>
